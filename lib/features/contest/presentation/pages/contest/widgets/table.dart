      ...
      child: SingleChildScrollView(
        ...
        child: DataTable(
            ...
            columns: const [
              ...
              DataColumn(label: Text('Allowed hours')),
              DataColumn(label: Text('Total Participients')),
...
class FixedColumnWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return DataTable(
      columnSpacing: 10,
      // border: TableBorder(
      // right: BorderSide(color: const Color.fromARGB(255, 211, 211, 211)),
      // left: BorderSide(color: Color.fromARGB(255, 233, 233, 233)),
